...
export const goToEx01 = (navigate) => {
  navigate("/exercicio01");
};

export const goToEx02 = (navigate) => {
  navigate("/exercicio02");
};

export const goToEx03 = (navigate) => {
  navigate("/exercicio03");
};
